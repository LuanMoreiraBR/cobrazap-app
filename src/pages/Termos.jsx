export default function Termos() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px', color: '#1e293b', lineHeight: 1.7 }}>
      <h1>Termos de Uso — Lembrei App</h1>

      <p style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 12, padding: '14px 20px', fontSize: 14, color: '#475569' }}>
        <strong>Operadora:</strong> Lembrei App é o nome comercial da plataforma operada por{' '}
        <strong>66.459.618 LUAN WINICIUS MOREIRA</strong>.
      </p>

      <h2>1. Uso do serviço</h2>
      <p>
        Ao acessar o Lembrei App, você concorda em cumprir estes termos e todas as leis aplicáveis.
      </p>

      <h2>2. Licença</h2>
      <p>
        É permitido utilizar a plataforma apenas para uso pessoal e comercial legítimo.
      </p>

      <h2>3. Limitações</h2>
      <p>
        O Lembrei App não se responsabiliza por perdas decorrentes do uso da plataforma.
      </p>
